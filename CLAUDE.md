...
clojure -T:build jar                  # library jar → target/web-base-0.4.0.jar (no demo inside)
...
clojure -T:build demo-uber            # runnable demo → target/web-base-demo-0.4.0.jar (18 MB, never published)
WB_SESSION_KEY=<base64 of 16 bytes> java -jar target/web-base-demo-0.4.0.jar [port]

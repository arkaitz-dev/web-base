...
dev.arkaitz/web-base {:mvn/version "0.3.0"}
...
clojure -M:demo [port]
clojure -T:build demo-uber && java -jar target/web-base-demo-0.3.0.jar [port]
```
...
clojure -T:build jar            # target/web-base-0.3.0.jar
